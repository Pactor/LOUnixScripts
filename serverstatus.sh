...
./lo start $SERVER1NAME $SERVER1PORT $SERVER1QUERY $CUSTKEY $SERVER1PROVKEY
fi

if [ -z "$ACTIVE2" ]; then
echo "Server2 is down"
./lo start $SERVER2NAME $SERVER2PORT $SERVER2QUERY $CUSTKEY $SERVER2PROVKEY
fi

if [ -z "$ACTIVE3" ]; then
echo "Server3 is down"
./lo start $SERVER3NAME $SERVER3PORT $SERVER3QUERY $CUSTKEY $SERVER3PROVKEY
fi

if [ -z "$ACTIVE4" ]; then
echo "Server4 is down"
./lo start $SERVER4NAME $SERVER4PORT $SERVER4QUERY $CUSTKEY $SERVER4PROVKEY
fi

if [ -z "$ACTIVE5" ]; then
echo "Server5 is down"
./lo start $SERVER5NAME $SERVER5PORT $SERVER5QUERY $CUSTKEY $SERVER5PROVKEY
fi

if [ -z "$ACTIVE6" ]; then
echo "Server6 is down"
./lo start $SERVER6NAME $SERVER6PORT $SERVER6QUERY $CUSTKEY $SERVER6PROVKEY
fi

if [ -z "$ACTIVE7" ]; then
echo "Server7 is down"
./lo start $SERVER7NAME $SERVER7PORT $SERVER7QUERY $CUSTKEY $SERVER7PROVKEY
fi

if [ -z "$ACTIVE8" ]; then
echo "Server8 is down"
./lo start $SERVER8NAME $SERVER8PORT $SERVER8QUERY $CUSTKEY $SERVER8PROVKEY
fi
